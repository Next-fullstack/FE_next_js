...
import RegisterForm from "@/components/RegistetForm"
            ...
            <div className="flex min-h-screen w-full items-center justify-center px-4 py-8 md:w-1/2 md:px-8 lg:px-12 xl:px-16">
                <div className="w-full max-w-md space-y-6">
                    <div className="space-y-2 text-center">
                        ...
                        <p className="text-muted-foreground">Sudah punya akun? <Link href={'/login'} className="font-semibold hover:underline hover:underline-offset-1">daftar</Link></p>
                    </div>
                    <RegisterForm />
                </div>
            </div>
